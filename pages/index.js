      ...
      <Nav/>
        ...
        <div className="jumbotron jumbotron-fluid" id="main">
          <div className="container">
            ...
            <h1 className="display-5"><b>Traffic court sucks. Period.</b></h1>
            <p className="lead">Let the experts fight on your behalf.</p>
          </div>
        </div>

        <div className="row section options">
          <h1 className="display-5">You have options. Choose wisely.</h1>
        ...
        <div className="row section">
          ...
          <h1 className="display-5 pt-3"><b>01. — Court Valet</b></h1>
        ...
        <div className="cta">
          <h3 className="display-5">Save time and energy.<br/>Get started on your case today.</h3>
        </div>

        <div className="section legacy">
          <h3 className="display-5"><b>Our Legacy</b></h3>
